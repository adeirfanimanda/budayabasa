...
class PengaturanUsersController extends Controller
{
    ...
    public function changepassword(Request $request)
    {
        ...
        if (Hash::check($validatedData['passwordLama'], auth()->user()->password)) {
            ...
            return redirect('/pengaturan')->with('passwordUpdateSuccess', 'Kata sandi berhasil diupdate!');
            exit;
        } else {
            return redirect('/pengaturan')->with('passwordLamaSalah', 'Kata sandi lama Anda salah!');
        }
    }
}
