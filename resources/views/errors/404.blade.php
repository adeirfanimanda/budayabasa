...
<div class="container-xxl container-p-y">
    <div class="misc-wrapper">
        ...
        <button onclick="window.location.href = '/'" class="btn btn-dark"><i class='bx bxs-home bx-tada fs-6 me-1'
                style="margin-bottom: 3.4px;"></i> Back to Home</button>
        <div class="mt-3">
            <img src="{{ asset('assets/vendors/assets/img/illustrations/page-misc-error-light.png') }}"
                alt="404 Error Not Found" width="500" class="img-fluid">
        </div>
    </div>
</div>
