                    ...
                    <form action="/admin/data-kamus/search">
                        <div class="input-group">
                            <input type="search" class="form-control" value="{{ request('q') }}" name="q"
                                id="search" style="border: 1px solid #d9dee3;" placeholder="Cari Data Kamus..."
                                autocomplete="off" />
                        </div>
                    </form>
                </div>
                                ...
                                @if ($dictionaries->isEmpty())
                                    <tr>
                                        <td colspan="100" class="text-center">
                                            Data kamus tidak ditemukan dengan keyword pencarian:
                                            <b>"{{ request('q') }}"</b>
                                        </td>
                                    </tr>
                                @endif
...
<div class="modal fade" id="formModalAdminDictionary" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="/admin/data-kamus" method="post" class="modalAdminDictionary" enctype="multipart/form-data">
            @csrf
