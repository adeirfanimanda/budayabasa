                        ...
                        <form id="formAuthentication" class="mb-3" action="/register" method="POST">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="namaLengkap" name="name" value="{{ old('name') }}"
                            ...
                            <div class="mb-2">
                                ...
                                @else
                                    <div class="form-text descUsername">
                                        Username minimal 5 karakter (Hanya boleh huruf & angka).
                                    </div>
                                @enderror
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2 form-password-toggle">
                                <label class="form-label required-label" for="password">Kata Sandi</label>
                            ...
                            <div class="mb-3 form-password-toggle">
                                <label class="form-label required-label" for="password2">Ulangi Kata Sandi</label>
                                <div class="input-group input-group-merge">
                            ...
                            <div class="mb-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms-conditions">
                                        Saya setuju dengan&nbsp;<a @error('terms') style="color:#ff3e1d;" @enderror
                                            href="/terms">syarat & ketentuan</a>
                                    </label>
                                </div>
                            </div>
                            <div class="mb-3 divBtn" style="cursor: not-allowed;">
                                <button class="btn btn-primary d-grid w-100 tombolDaftar disabled"
